      ...
      <div className="face">
        <div className="part">
          <div className="left">
            ...
            <p className="para">Knowledge is Power, Learning is the Fuel</p>
      ...
      <div className="hext">
        <div className="hcon">
          <div className="hcon-head">
            <h1 className="hcon-head">Learn with Videos
            </h1>
          </div>
          <div className="vlist">

            <li>🎥 Master Sign Language with Engaging Videos</li>
            <li>☑️ Step-by-step tutorials</li>
            <li>☑️ Real-life sign language demonstrations</li>
            <li>☑️ Easy-to-follow lessons</li>
