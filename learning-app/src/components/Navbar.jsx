  ...
  return (
    <div className="navi">
        <div className="nav">
            ...
            <div className="tuto"><Link to="/tutorials" id='l1'>Tutorials</Link></div>
            <div className="certi"><Link to="/certification" id='l1'>Certification</Link></div>
            <div className="book"><Link to="/books" id='l1'x>Books</Link></div>
